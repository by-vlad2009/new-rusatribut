...
if( env( 'SHOP_MULTISHOP' ) ) {
	$multishop = ['routes' => [
		...
		'default' => ['prefix' => $prefix . '{site}/shop1', 'middleware' => ['web']],
		'basket' => ['prefix' => $prefix . '{site}/shop1', 'middleware' => ['web']],
...
return array_replace_recursive( $multiroute, $multishop + [
	...
	'routes' => [
		...
		//'default' => ['prefix' => $prefix . 'product', 'middleware' => ['web']],
		'default' => ['prefix' => $prefix, 'middleware' => ['web']],
		...
		'page' => ['prefix' => $prefix . 'page', 'middleware' => ['web']],
	...
	'resource' => [
		...
		'fs-theme' => [
			...
			'basedir' => public_path( '/public/vendor/shop/themes' ),
			//'baseurl' => rtrim(env('ASSET_URL', PHP_SAPI == 'cli' ? env('APP_URL') : ''), '/') . '/vendor/shop/themes',
			'baseurl' => rtrim(env('ASSET_URL', PHP_SAPI == 'cli' ? env('APP_URL') : ''), '/') . '/public/vendor/shop/themes',
		],
		'fs-admin' => [
			'adapter' => 'Standard',
			'tempdir' => storage_path( 'tmp' ),
